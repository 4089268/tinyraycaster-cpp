...
int main()
{
    ...
    float player_x = 3.456; // player initial coordinates
    float player_y = 2.345;
    float player_a = 1.523; // player view direction
    const float fov = M_PI/3; // flied of view
    ...
    for(size_t frame = 0; frame < 360; frame++)
    {
        ...
        for( float i=0; i<win_w/2; i++)
        {
            ...
            for( float t=0; t<win_w; t+=0.01)
            {
                ...
                // if the ray touches a wall, draw a vertial column to create an illusion of 3D
